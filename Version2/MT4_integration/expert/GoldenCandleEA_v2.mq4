...
int start() {
    ...
    // Simulate pause trading action (in real use, set by GUI or user action)
    ...
    // Simulate skip level action (in real use, set by GUI or user action)
    // Uncomment to test skip:
    // SkipLevel();
